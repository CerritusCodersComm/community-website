...
export const Testimonials = () => {
    return (
        <div className="bg-white md:px-4" id="testimonials">
            <div className="lg:px-40 md:px-6 bg-[#F2f2f2] px-4 py-4  py-12">
                <div className="flex flex-col items-center justify-center">
                    <h1 className="lg:text-4xl text-3xl font-bold text-center text-gray-800">Hear from our community
                        members</h1>
                ...
                <div className="w-full lg:flex items-center gap-6 mt-10">
                    {
                        testimonialItems.map(({name, quote, image}, idx) => (
                            <div className="lg:w-1/2 lg:mt-0 mt-16" key={idx}>
