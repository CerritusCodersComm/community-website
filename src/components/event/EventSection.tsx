...
export const EventSection: FC = () => {
    return (
        <div className="bg-white p-4 pt-0" id="events">
            <div className="bg-[#F1F6F0] text-black font-satoshi">
                <div className="pl-4">
                    <div className="text-5xl font-bold tracking-widest pl-8 pt-4">
                        Events
                    </div>
                    <div className="w-[235px] h-8 border-underLine border-b-6 rounded-smileUnderLine "></div>
                </div>
                <div className="text-[20px] tracking-wide leading-relaxed text-center text-[#7D7D7D]  py-10">
