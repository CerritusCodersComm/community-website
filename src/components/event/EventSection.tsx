    ...
    <div className="bg-white p-4 pt-0">
      <div className="bg-[#F1F6F0] text-black font-satoshi">
        <div className="pl-4">
          ...
          <div className="w-[190px] h-8 border-underLine border-b-6 rounded-smileUnderLine hidden md:block "></div>
        </div>
        ...
        <div className="bg-[#DCF7E7] mx-auto max-w-[20%] px-20 py-10 md:flex md:justify-center md:h-[107px] md:text-[20px] md:tracking-wide md:mx-20 md:max-w-full">
          <div className="flex text-center text-black items-center gap-20 flex-col md:flex-row md:gap-80">
