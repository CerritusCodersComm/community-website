  ...
  return (
    <div className="bg-white p-4 ">
      <div className="bg-[#F1F6F0] text-black font-satoshi ">
        <div className="pl-4">
          <div className="text-3xl font-bold tracking-widest pl-8 pt-4 md:text-5xl">Meet Our Team</div>
          <div className="w-[320px] h-8 border-underLine border-b-6 rounded-smileUnderLine ml-12 hidden md:block"></div>
        </div>
