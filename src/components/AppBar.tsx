  ...
  return (
    <nav className="flex justify-between bg-white text-black font-grotesk font-bold shadow-md">
      <div className="mt-3 ml-6">
        <Image src={cerritusCodersLogo} height={70} width={140} />
      </div>
      <div
      ...
      >
            ...
            >
              <ul>
                <Link href={link.path}>
                  <li
                    key={index}
                    className="font-bold transition duration-150 border-b-4 border-transparent hover:border-purple-500 lg:ml-8 text-xl lg:my-0"
                  >
                    {link.name}
                  </li>
                </Link>
        ...
        <div className="flex items-center">
          <button className="border-3 space-x-1 m-2 border-purple-400 rounded-full p-2 content-center h-11 items-center justify-center bg-lightPurple font-bold hover:bg-purple-500 px-6 bg-transition duration-300">
            join our community
          </button>
        </div>
      </div>
