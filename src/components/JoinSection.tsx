...
export const JoinSection: FC = () => {
    return (
        <div className="bg-white p-4">
            <div className="h-3/4">
                <div
                    className="max-w-3xl mx-auto text-[36px] tracking-wide leading-relaxed font-satoshi font-bold text-center text-black justify-center">
                    Join Our Community
                </div>
                <div
                    className="mx-auto text-[20px] tracking-wide leading-relaxed font-satoshi text-center text-[#7D7D7D] justify-center mb-4">
